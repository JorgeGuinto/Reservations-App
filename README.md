# Reservetion Application
This is a project to create a webpage where an user can access and add reservations of different amenities.
The purpose is to keep practicing my java and spring boot skills.
...
```
java -Dspring.profiles.active=production -jar ./target/reservation-demo-0.0.1-SNAPSHOT.jar
```
